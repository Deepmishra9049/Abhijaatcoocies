...
<title>NOBITA MULTI-USER MESSAGING SYSTEM</title>
<style>
  * {
...
const server = app.listen(PORT, () => {
  console.log(`🌹 Nobita Multi-User System running at http://localhost:${PORT}`);
...
// 🌹 Prevent Hosting Sleep - Auto Ping Every 4 Minutes (Silent)
setInterval(() => {
  try {
